...
3.	**Funcionalidad Básica del Sistema (Versión 1). AGOSTO 2018**.
   ...
   **PUEDE VERSE UNA DEMOSTRACIÓN DE LA HERRAMIENTA EN ESTE [LINK]**(http://www.galileoiys.es/)
...
---
**Hemos preparado una [página web](http://www.galileoiys.es/) en la que se puede ver en operación la plataforma, así como obtener más información sobre el proyecto, líneas futuras de desarrollo, etc.**
